package com.danhdueexoictif.statemachine.utils.networkdetection
...
import com.danhdueexoictif.statemachine.data.remote.HttpResponseCode
import com.danhdueexoictif.statemachine.utils.Constants.NetworkSettings.DOUBLE_CHECK_CONNECTION_TIME_OUT
...
object NoInternetUtils {
    ...
    fun hasActiveInternetConnection(): Boolean {
        try {
            ...
            urlConnection.connectTimeout = DOUBLE_CHECK_CONNECTION_TIME_OUT
