...
object Dependencies {
    object AndroidX : Libraries {
        object Version {
            ...
            const val supportV4: String = "1.0.0"
        }
        ...
        const val navigationDFM: String = "androidx.navigation:navigation-dynamic-features-fragment:${Version.navigation}"
        ...
        const val supportV4 = "androidx.legacy:legacy-support-v4:${Version.supportV4}"

        override val components: List<String>
            get() = listOf(coreKtx, navigationFragmentKtx, navigationUiKtx, navigationDFM, multiDex, activity, lifeCycleCommon, viewModel, liveData, supportV4)
    }
    ...
    object Kotlin {
        const val stdlib: String = "org.jetbrains.kotlin:kotlin-stdlib:$kotlinVersion"
    }
